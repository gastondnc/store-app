...
export const CheckOut = () => {
    ...
    return (
        <>
            ...
            <form className="bg-gray-800 p-4 rounded-lg" onSubmit={handleSubmit}>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="city" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            {mappedProvinces()}
                        </select>
                    </div>
                    <div className="mb-6">
